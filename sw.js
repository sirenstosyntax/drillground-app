...
var CACHE_VERSION = "drillground-v20";
...
//
// Unlocked paid payloads are deliberately NOT here: they are fetched only
// after a Play purchase and a required shell entry that 404s fails the
// whole install. The public catalog stays optional. The TWA store catalog
// is also optional so a browser-only visit does not depend on it.
// Resource JSON is network-first so a republish refreshes without a bump.
var OPTIONAL = ["drill_resources.published.json", "drill_resources.store.json"];
